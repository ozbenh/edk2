...
#ifndef _PNVOPALLIB_H_
#define _PNVOPALLIB_H_

// Define types needed by OPAL API
...
//
// Explicit Library init
// (when not calling constructor)
//
void PnvOpalLibInit(IN VOID *OpalBase,
		    IN VOID *OpalEntry);
