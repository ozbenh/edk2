  ...
  )
{
  ...
  for (Idx = 0; Idx < NoHandles; ++Idx) {
    ...
    DEBUG ((EFI_D_INFO, " Filtering path %ls\n", DevicePathText));
  ...
  )
{
  ...
  // them.
  //
  DEBUG ((EFI_D_INFO, "Processing PCI root bridge...\n"));
  ...
  //
  DEBUG ((EFI_D_INFO, "Processing PCI Displays...\n"));
  ...
  // ErrOut.
  //
  DEBUG ((EFI_D_INFO, "Processing GOPs...\n"));
  ...
  PlatformBdsEnterFrontPage (10, TRUE);
}
