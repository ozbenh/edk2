...
#include <Library/ppc_bitutils.h>
...
#define SPR_SPRG0       0x110   /* RW: Special Purpose Register General 0 */
#define SPR_SPRG1       0x111   /* RW: Special Purpose Register General 1 */
#define SPR_SPRG2       0x112   /* RW: Special Purpose Register General 2 */
#define SPR_SPRG3       0x113   /* RW: Special Purpose Register General 3 */
...
#define SPR_HDSISR      0x132   /* RW: HV DSI Status Reg */
#define SPR_HDAR        0x133   /* RW: HV Data Address Reg */
#define SPR_HDEC        0x136   /* RW: HV Decrementer */
#define SPR_HRMOR       0x139   /* RW: HV Real mode offset register */
...
#define SPR_LPCR_ILE            PPC_BIT(38)
#define SPR_LPCR_AIL            PPC_BITMASK(39,40)
...
#define SPR_LPCR_LPES           PPC_BIT(60)
...
{
        unsigned long val;
        asm volatile("mfspr %0,%1" : "=r"(val) : "i"(SPR_TBRL) : "memory");
        return val;
}
...
static inline UINT16 ld_be16(const UINT16 *addr)
{
        UINT16 val;
...
static inline UINT32 ld_be32(const UINT32 *addr)
{
        UINT32 val;
...
static inline void st_le16(UINT16 *addr, UINT16 val)
{
        asm volatile("sthbrx %0,0,%1" : : "r"(val), "r"(addr), "m"(*addr));
}

static inline void st_le32(UINT32 *addr, UINT32 val)
{
